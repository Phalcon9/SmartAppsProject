                ...
                mAuth.fetchSignInMethodsForEmail (Email).addOnCompleteListener (new OnCompleteListener<SignInMethodQueryResult> () {
                    ...
                    public void onComplete(@NonNull Task<SignInMethodQueryResult> task) {
                        ...
                        if (!check){
                            ...
                            fStore.collection ("teacher").whereEqualTo ("employeeNum", employeeNum).get ().addOnCompleteListener (new OnCompleteListener<QuerySnapshot> () {
                                @Override
...
//                            verifyEmail();
                            ...
                            Toast.makeText (TeacherReg.this, "Employee ID already exist", Toast.LENGTH_SHORT).show ();
                        }
                    }
                });
            }
            else {
                Toast.makeText (TeacherReg.this, "User details already exist", Toast.LENGTH_SHORT).show ();
            }
        }
    });
