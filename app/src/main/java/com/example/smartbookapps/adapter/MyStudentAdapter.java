...
public class MyStudentAdapter extends RecyclerView.Adapter<MyStudentAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyStudentAdapter.MyViewHolder holder, @SuppressLint("RecyclerView") int position) {
        holder.firstName1.setText ("Matriculation Number  : " + studentUsersArrayList.get(position).getfName ());
        holder.matricNum1.setText ("Phone Number: "+ studentUsersArrayList.get (position).getMatricNum ());
        holder.category1.setText ("Email : "+studentUsersArrayList.get (position).getCategory ());
        holder.phone.setText ("Category : "+studentUsersArrayList.get (position).getPhoneNum ());
        holder.email1.setText (" Name: "+studentUsersArrayList.get (position).getEmail ());
